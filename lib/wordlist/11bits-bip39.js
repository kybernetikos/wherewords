 ...
 *
 * bip39
 *    Used extensively for bitcoin wallet seed phrases.
 *    First four letters unambiguously identify the word, word pairs removed.
 *    See https://github.com/bitcoin/bips/blob/master/bip-0039/bip-0039-wordlists.md
 *    items: 2048
 *    useful bits: 11
 *
 * Awkward for geographic use, as it contains some words that could cause distress.
 */

export const bip39 = ["abandon", "ability", "able", "about", "above", "absent", "absorb",
    ...
    "afford", "afraid", "again", "age", "agent", "agree", "ahead", "aim", "air", "airport", "aisle",
    ...
    "blind", "blood", "blossom", "blouse", "blue", "blur", "blush", "board", "boat", "body", "boil",
    ...
    "hope", "horn", "horror", "horse", "hospital", "host", "hotel", "hour", "hover", "hub", "huge",
    ...
    "jacket", "jaguar", "jar", "jazz", "jealous", "jeans", "jelly", "jewel", "job", "join", "joke",
    ...
    "monkey", "monster", "month", "moon", "moral", "more", "morning", "mosquito", "mother",
    ...
    "snack", "snake", "snap", "sniff", "snow", "soap", "soccer", "social", "sock", "soda", "soft",
